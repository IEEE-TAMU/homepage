      ...
      <section className="py-16">
        <div className="container relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Activities Branch</h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Event planning, community outreach, and member engagement
              initiatives.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  The Activities Branch is the heart of IEEE TAMU&apos;s
                  community engagement. We plan and execute events that bring
                  our members together, foster relationships, and create
                  memorable experiences that strengthen our organization.
                </p>
                <p className="text-muted-foreground">
                  From social gatherings to community service projects, we work
                  to create a vibrant and inclusive environment where every
                  member feels connected and valued.
                </p>
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Market the event and ensure smooth execution on the day
                        of
                      </p>
                    </div>
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Love planning events and bringing people together? The
                  Activities Branch is perfect for creative, organized
                  individuals who enjoy making things happen.
                </p>
