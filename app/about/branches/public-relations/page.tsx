    ...
    <div className="min-h-screen bg-background">
      <MainSection>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">About Public Relations</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground mb-4">
                The Public Relations (PR) Branch shapes how IEEE TAMU
                communicates with students, partners, and the community. We
                manage the organization’s brand, craft compelling messages, and
                ensure consistent, accessible information across channels.
              </p>
              <p className="text-muted-foreground">
                From social media and newsletters to graphics and event
                promotion, PR amplifies the impact of every branch and keeps our
