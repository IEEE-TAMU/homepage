            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  ...
                  technical and educational experiences for IEEE TAMU members.
                  We organize workshops, seminars, conferences, and other
                  learning opportunities that help our members develop their
                  technical skills and stay current with industry trends.
                </p>
                <p className="text-muted-foreground">
                  Our team works closely with industry experts, faculty, and
                  guest speakers to bring valuable content and hands-on learning
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-l-4 border-secondary pl-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      technologies and practical skills for engineering
                      students.
                    </p>
                  </div>
