        ...
        <div className="container relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1">
          ...
          <div className="text-center mb-12 mt-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Membership opens doors to exclusive opportunities, resources, and
              a global network of engineering professionals.
            </p>
          </div>
        ...
        <div className="container relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-12">
              Getting started with IEEE TAMU is easy. Follow these simple steps
              to become a member.
            </p>
