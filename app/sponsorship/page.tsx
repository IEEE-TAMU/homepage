        ...
        <div className="container relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Access top engineering talent, increase brand visibility, and make
              a meaningful impact on STEM education.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Support STEM education and community outreach programs that
                  make a lasting difference in engineering education.
                </p>
                <ul className="text-sm text-left space-y-2">
                  <li className="flex items-center space-x-2">
                    <CheckCircleIcon className="h-4 w-4 text-primary" />
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Begin engaging with our community through events, workshops,
        ...
        <div className="container relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-1">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Let&apos;s discuss how your company can benefit from partnering
              with IEEE TAMU and supporting engineering education at{' '}
